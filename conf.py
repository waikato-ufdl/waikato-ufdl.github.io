...
BLOG_TITLE = "User-friendly Deep Learning"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ufdl.cms.waikato.ac.nz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "fracpete@waikato.ac.nz"
BLOG_DESCRIPTION = "Making deep learning accessible to domain experts without having to rely on machine learning experts"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((
          ...
          ("https://github.com/waikato-datamining/pytorch/tree/master/detectron2", "Pytorch Detectron2"),
          ("https://github.com/waikato-datamining/pytorch/tree/master/image-classification", "Pytorch Image Classification"),
          ("https://github.com/waikato-datamining/pytorch/tree/master/yolov5", "Pytorch Yolov5"),
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; 2019-{date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
RSS_COPYRIGHT = 'Contents © 2019-{date} <a href="mailto:{email}">{author}</a> {license}'
RSS_COPYRIGHT_PLAIN = 'Contents © 2019-{date} {author} {license}'
